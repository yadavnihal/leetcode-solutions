<h1>2377 - Check if Number Has Equal Digit Count and Digit Value</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-if-number-has-equal-digit-count-and-digit-value/">check-if-number-has-equal-digit-count-and-digit-value</a></h2><p>You are given a <strong>0-indexed</strong> string <code>num</code> of length <code>n</code> consisting of digits.</p>
