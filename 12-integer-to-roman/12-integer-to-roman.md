<h1>12 - Integer to Roman</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/integer-to-roman/">integer-to-roman</a></h2><p>Seven different symbols represent Roman numerals with the following values:</p>
