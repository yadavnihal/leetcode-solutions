<h1>3643 - Zero Array Transformation II</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/zero-array-transformation-ii/">zero-array-transformation-ii</a></h2><p>You are given an integer array <code>nums</code> of length <code>n</code> and a 2D array <code>queries</code> where <code>queries[i] = [l<sub>i</sub>, r<sub>i</sub>, val<sub>i</sub>]</code>.</p>
